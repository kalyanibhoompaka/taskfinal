...
(function ($, Drupal) {
  Drupal.behaviors.customTabs = {
    attach: function (context, settings) {
      // Ensure this runs only once in a context
      $('.nav-tabs a', context).once('tabClickBehavior').click(function (e) {
        e.preventDefault();

        var tabId = $(this).data('tab'); // Get the tab ID from the data-tab attribute
        var $tabs = $(this).closest('.nav-tabs').find('li');
        var $tabPanes = $(this).closest('.tabs-section').find('.tab-pane');
