...
/* themes/custom/my_custom_theme/templates/views/views-view--viewtab2--block_1.html.twig */
class __TwigTemplate_e0975cd741bf7e3ad076dd281cd65af00f420d2aa0829b15de41d1a786a82224 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["dom_id"] ?? null)) ? (("js-view-dom-id-" . $this->sandbox->ensureToStringAllowed(($context["dom_id"] ?? null), 39, $this->source))) : (""))];
  ...
  <button class=\"carousel-nav prev\" id=\"carousel-prev-r\" aria-label=\"Previous Slide\" style=\"margin-left: -100px;\">&lt;</button>
...
($context["empty"] ?? null)) {
  ...
  <button class=\"carousel-nav next\" id=\"carousel-next-r\" aria-label=\"Next Slide\" style=\"margin-right: -100px;\">&gt;</button>
</div>
...
";
    ...
    {
        return "themes/custom/my_custom_theme/templates/views/views-view--viewtab2--block_1.html.twig";
    }
...
", "themes/custom/my_custom_theme/templates/views/views-view--viewtab2--block_1.html.twig", "D:\\xampp\\htdocs\\drupaltask\\themes\\custom\\my_custom_theme\\templates\\views\\views-view--viewtab2--block_1.html.twig");
    }
